...
def test_figure_uno_BPASS():
    ...
    plt.plot(np.log10(iso.primaries['Teff']), np.log10(iso.primaries["L"]), "r.")
    plt.plot(np.log10(iso.secondaries['Teff']), np.log10(iso.secondaries["L"]), "r.")
    plt.plot(np.log10(iso.singles['Teff']), np.log10(iso.singles["L"]), "r.", label="BPASS isochrone")
    ...
    He_star_region = iso.primaries[np.where((np.log10(iso.primaries['Teff']) <= 4.75) &
                                            (np.log10(iso.primaries['Teff']) >= 4.25) &
                                            (np.log10(iso.primaries['L']) >= 27.5) &
                                            (np.log10(iso.primaries['L']) <= 29))]
    ...
    He_star_second = iso.secondaries[np.where((np.log10(iso.primaries['Teff']) <= 4.75) &
                                              (np.log10(iso.primaries['Teff']) >= 4.25) &
                                              (np.log10(iso.primaries['L']) >= 27.5) &
                                              (np.log10(iso.primaries['L']) <= 29))]
